...
@section('title', 'Login Verification - PetrogenAI')
...
<div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-bold text-gray-900">Verify Your Login</h2>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="mt-6 text-center">
                <form method="POST" action="{{ route('login.verify.resend') }}" class="inline">
                    @csrf
